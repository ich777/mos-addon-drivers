...
make install -j$(nproc --all) MDIR=$DRIVER_PACKAGE_DIR CONFIG_DVB_STB6100=m KCFLAGS="-DCONFIG_MEDIA_TUNER_TDA18271_MODULE=1 -DCONFIG_MEDIA_TUNER_TDA8290_MODULE=1 -DCONFIG_DVB_STV6110x_MODULE=1 -DCONFIG_DVB_STV6111_MODULE=1" KDIR=$KERNEL_DIR
